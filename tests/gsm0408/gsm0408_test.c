...
static void dump_cm3(struct gsm48_classmark3 *cm3)
{
	...
	printf("hscsd_mult_slot_cap.class=%02x\n",
	       cm3->hscsd_mult_slot_cap.class);
	printf("\n");
	...
	printf("ecsd_multislot_cap.class=%02x\n",
	       cm3->ecsd_multislot_cap.class);
	printf("\n");
	...
	printf("dtm_gprs_multislot_cap.class=%02x\n",
	       cm3->dtm_gprs_multislot_cap.class);
	...
	printf("dtm_gprs_multislot_cap.dtm_egprs_multislot_cap.class=%02x\n",
	       cm3->dtm_gprs_multislot_cap.dtm_egprs_multislot_cap.class);
	printf("\n");
	...
	printf("extended_dtm_gprs_multislot_cap.class=%02x\n",
	...
	printf
	    ("extended_dtm_gprs_multislot_cap.dtm_egprs_multislot_cap.class=%02x\n",
	     cm3->extended_dtm_gprs_multislot_cap.
	...
	printf("dtm_gprs_high_multislot_cap.class=%02x\n",
	...
	printf
	    ("dtm_gprs_high_multislot_cap.dtm_egprs_high_multislot_cap.present=%u\n",
	     ...
	     present);
	printf
	    ("dtm_gprs_high_multislot_cap.dtm_egprs_high_multislot_cap.class=%02x\n",
	     cm3->dtm_gprs_high_multislot_cap.dtm_egprs_high_multislot_cap.
	     class);
	printf("\n");
